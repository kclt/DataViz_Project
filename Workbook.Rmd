...
```{r NASA_surfacetemp}
# figure this out later ahhhhhhhhhhh
...
temp <- read.table("./Source/NASA/amaps.txt", skip=1, header = TRUE, na.strings="9999.0000")
...
rotate_map <- function(angle = -74){
  ggplot() + 
    geom_tile(data = temp, aes(x = lon, y = lat, fill = array.i.j.), alpha = 0.8) +
